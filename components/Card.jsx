...
const Card = ({
  ...
  return (
    <div className="w-[300px] h-[400px] shadow-md border border-1 border-white bg-white">
      <div className="p-3">
        ...
        <section className="w-full bg-[#9ca1a5] hover:bg-accent cursor-pointer py-1 rounded-md">
          {" "}
